...
class RedisStorage extends Storage {
    ...
    _isScheduledCancel(taskId) {
        return this._someClientParallel('isScheduledCancel', taskId).then(res => !!res);
    }
    ...
    _isScheduledUpdate(taskId, data, intervalSeconds = undefined) {
        return this._someClientParallel('isScheduledUpdate', taskId, data, intervalSeconds).then(res => !!res);
    }
